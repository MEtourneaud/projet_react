...
const Cgu = () => {
  return (
    <>
      ...
      <p>
        L'hébergeur du site https://www.archives-ohara.fr est la société Les Archives d'Ohara, dont
        le siège social est situé au Ohara, avec le numéro de téléphone : 05 12 34 56 67.
      </p>
      ...
      <p>
        ...
        état civil et ses coordonnées, notamment son adresse email. Pour accéder aux services,
        ...
        inscrit pourra également solliciter sa désinscription en se rendant à la page dédiée sur son
        espace personnel. Celle-ci sera effective dans un délai raisonnable. Tout événement dû à un
        cas de force majeure ayant pour conséquence un dysfonctionnement du site ou serveur et sous
        réserve de toute interruption ou modification en cas de maintenance, n'engage pas la
        responsabilité de https://www.archives-ohara.fr. Dans ces cas, l’Utilisateur accepte ainsi
        ne pas tenir rigueur à l’éditeur de toute interruption ou suspension de service, même sans
      ...
      <p>
        ...
        personnelles. L'Utilisateur exerce ce droit : · via un formulaire de contact ;
      </p>
      ...
      <p>
        ...
        contractuelle. Malgré des mises à jour régulières, le site https://www.archives-ohara.fr ne
        peut être tenu responsable de la modification des dispositions administratives et juridiques
        survenant après la publication. De même, le site ne peut être tenue responsable de
        l’utilisation et de l’interprétation de l’information contenue dans ce site. L'Utilisateur
        s'assure de garder son mot de passe secret. Toute divulgation du mot de passe, quelle que
        soit sa forme, est interdite. Il assume les risques liés à l'utilisation de son identifiant
        et mot de passe. Le site décline toute responsabilité. Le site https://www.archives-ohara.fr
        ne peut être tenu pour responsable d’éventuels virus qui pourraient infecter l’ordinateur ou
        tout matériel informatique de l’Internaute, suite à une utilisation, à l’accès, ou au
      ...
      <p>
        ...
        cliquant sur ces liens, il sortira du site https://www.archives-ohara.fr. Ce dernier n’a pas
        de contrôle sur les pages web sur lesquelles aboutissent ces liens et ne saurait, en aucun
      ...
      <p>
        ...
        https://www.archivesohara.fr. Les cookies ne contiennent pas d’information personnelle et ne
        peuvent pas être utilisés pour identifier quelqu’un. Un cookie contient un identifiant
        unique, généré aléatoirement et donc anonyme. Certains cookies expirent à la fin de la
      ...
      <p>
        ...
        consentement quant à l’utilisation de certains cookies. 3A défaut d’acceptation,
