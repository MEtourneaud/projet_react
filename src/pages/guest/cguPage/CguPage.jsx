    ...
    <>
      ...
      <div className="cguContainer">
        ...
        <p>
          ...
          _______________ et de définir les conditions d’accès et d’utilisation des services par «
          l'Utilisateur ».
        </p>
        ...
        <p>
          ...
          Formulaire d’inscription, chaque utilisateur accepte expressément les présentes CGU en
          cochant la case précédant le texte suivant : « Je reconnais avoir lu et compris les CGU et
          je les accepte ». En cas de non-acceptation des CGU stipulées dans le présent contrat,
          l'Utilisateur se doit de renoncer à l'accès des services proposés par le site.
          https://www.archives-ohara.fr se réserve le droit de modifier unilatéralement et à tout
          moment le contenu des présentes CGU.
        </p>
        <h3>ARTICLE 1 : LES MENTIONS LÉGALES</h3>
        <p>
          L’édition et la direction de la publication du site https://www.archives-ohara.fr est
          assurée par Etourneaud Mathieu, domicilié Ohara. Numéro de téléphone est 06 12 34 56 67
          Adresse e-mail mathieu.etourneaud@lapiscine.pro.
        </p>
        <p>
          L'hébergeur du site https://www.archives-ohara.fr est la société Les Archives d'Ohara,
          dont le siège social est situé au Ohara, avec le numéro de téléphone : 05 12 34 56 67.
        </p>
        <h3>ARTICLE 2 : ACCÈS AU SITE</h3>
        <p>
          Le site https://www.archives-ohara.fr permet à l'Utilisateur un accès gratuit aux services
          suivants : Le site internet propose les services suivants : Le site les Archives d'Ohara
          permet d’accéder gratuitement aux services suivants :
        </p>
        <p>
          - Catalogue de divers mangas - Création de sa propre bibliothèque - Notes et commentaires
          des différents utilisateurs sur les œuvres disponibles Le site est accessible gratuitement
          en tout lieu à tout Utilisateur ayant un accès à Internet. Tous les frais supportés par
          l'Utilisateur pour accéder au service (matériel informatique, logiciels, connexion
        ...
        <p>
          ...
          l’Utilisateur doit ensuite s'identifier à l'aide de son identifiant et de son mot de passe
          qui lui seront communiqués après son inscription. Tout Utilisateur membre régulièrement
          inscrit pourra également solliciter sa désinscription en se rendant à la page dédiée sur
          son espace personnel. Celle-ci sera effective dans un délai raisonnable. Tout événement dû
          à un cas de force majeure ayant pour conséquence un dysfonctionnement du site ou serveur
          et sous réserve de toute interruption ou modification en cas de maintenance, n'engage pas
          la responsabilité de https://www.archives-ohara.fr. Dans ces cas, l’Utilisateur accepte
          ainsi ne pas tenir rigueur à l’éditeur de toute interruption ou suspension de service,
          même sans préavis. L'Utilisateur a la possibilité de contacter le site par messagerie
        ...
        <p>
          ...
          données personnelles. L'Utilisateur exerce ce droit : · via un formulaire de contact ;
        </p>
        ...
        <p>
          Les sources des informations diffusées sur le site https://www.archives-ohara.fr sont
          réputées fiables mais le site ne garantit pas qu’il soit exempt de défauts, d’erreurs ou
          d’omissions.
        </p>
        <p>
          Les informations communiquées sont présentées à titre indicatif et général sans valeur
          contractuelle. Malgré des mises à jour régulières, le site https://www.archives-ohara.fr
          ne peut être tenu responsable de la modification des dispositions administratives et
          juridiques survenant après la publication. De même, le site ne peut être tenue responsable
          de l’utilisation et de l’interprétation de l’information contenue dans ce site.
          ...
          de son identifiant et mot de passe. Le site décline toute responsabilité. Le site
          https://www.archives-ohara.fr ne peut être tenu pour responsable d’éventuels virus qui
        ...
        <p>
          ...
          cliquant sur ces liens, il sortira du site https://www.archives-ohara.fr. Ce dernier n’a
          pas de contrôle sur les pages web sur lesquelles aboutissent ces liens et ne saurait, en
        ...
        <p>
          ...
          du site https://www.archivesohara.fr. Les cookies ne contiennent pas d’information
          personnelle et ne peuvent pas être utilisés pour identifier quelqu’un. Un cookie contient
          un identifiant unique, généré aléatoirement et donc anonyme. Certains cookies expirent à
        ...
        <p>
          ...
          https://www.archivesohara.fr.
        </p>
        <p>
          En naviguant sur le site, L’Utilisateur les accepte. L’Utilisateur doit toutefois donner
          son consentement quant à l’utilisation de certains cookies. 3A défaut d’acceptation,
        ...
        <p>Le site permet aux membres de publier les contenus suivants : commentaires, notes.</p>
        <p>
          Dans ses publications, le membre s’engage à respecter les règles de la Netiquette (règles
          de bonne conduite de l’internet) et les règles de droit en vigueur.
        </p>
        <p>
        ...
        <p>
          ...
          en publiant une publication sur le site, il cède à la société éditrice le droit non
          exclusif et gratuit de représenter, reproduire, adapter, modifier, diffuser et distribuer
          sa publication, directement ou par un tiers autorisé, dans le monde entier, sur tout
          support (numérique ou physique), pour la durée de la propriété intellectuelle. Le Membre
          cède notamment le droit d'utiliser sa publication sur internet et sur les réseaux de
          téléphonie mobile.
        </p>
        <p>
        ...
        <p>
          ...
          pour en connaître. Pour toute question relative à l’application des présentes CGU, vous
